...
static UINT8 ab_0_def_1019_00[EPLS_k_UDID_LEN] SAFE_INIT_SEKTOR = SAPL_k_SN3_UDID;
...
UINT8 getProcessData0(){
	return ab_0_act_ProcessData[0];
}

UINT8 getProcessData1(){
	return ab_0_act_ProcessData[1];
}
