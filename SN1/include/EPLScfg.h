/*
 * \file Stacl_SN\EPLScfg.h
 * \addtogroup Config_UDP_SN
 *
 * ****************************************************************************
...
**
**  Workfile: EPLScfg.h
**    Summary: EPLScfg - EPLsafety configuration file
**             EPLScfg, the EPLsafety configuration file.
**             This file contains all symbolic constants which are used to
**             configure the EPLS-Stack according to the
...
*/
#define EPLS_k_CONFIGURATION_STRING "SafetyNode Demo"
...
/* This define configures the maximum payload data length
   of a received slim SSDO Service Request or a transmitted slim SSDO Service Response on
   a SSDO server.
...
/* Maximum payload size of the Tx SPDOs in byte
   ...
   be set to 0.
*/
#define SPDO_cfg_MAX_LEN_OF_TX_SPDO             254

/* Maximum number of RxSPDOs to be synchronized over a TxSPDO
 * Allowed values: 1..1023 */
#define SPDO_cfg_MAX_SYNC_RX_SPDO       4
...
#define SPDO_cfg_MAX_NO_RX_SPDO                 2
