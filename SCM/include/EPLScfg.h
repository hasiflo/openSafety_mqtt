...
#define EPLS_k_CONFIGURATION_STRING  "SCM & SN"
#define b_OWN_SADR SAPL_k_SCM_SN1_SADR
...
#define EPLS_cfg_MAX_INSTANCES  2
...
/*  Define to enable or disable the XXX_GetErrorStr function
    ...
    for the error code.
    Allowed values: EPLS_k_ENABLE, EPLS_k_DISABLE */
#define EPLS_cfg_ERROR_STRING  EPLS_k_ENABLE
...
#define EPLS_cfg_MAX_PYLD_LEN  56 //original 12
...
#define SCM_cfg_MAX_NUM_OF_NODES  3 //original 100
...
/*  This define configures the number of processed Safety Nodes per call
    ...
    Allowed values:
     ...
     if EPLS_cfg_SCM == EPLS_k_DISABLE then EPLS_k_NOT_APPLICABLE */
#define SCM_cfg_NUM_OF_PROCESSED_NODES_PER_CALL  2
...
/*  This define configures the largest SADR in the SADR-DVI list and SOD index
    ...
    Allowed values:
     if EPLS_cfg_SCM == EPLS_k_ENABLE then 2..1023
     if EPLS_cfg_SCM == EPLS_k_DISABLE then EPLS_k_NOT_APPLICABLE */
#define SCM_cfg_MAX_SADR_VALUE  100
...
/*  Define to enable or disable the copy of the received SPDO frames within the
    ...
    Allowed values: EPLS_k_ENABLE, EPLS_k_DISABLE */
#define SPDO_cfg_FRAME_CPY_INTERN  EPLS_k_ENABLE
...
#define SPDO_cfg_MAX_SYNC_RX_SPDO  2

/*  Connection Valid bit field is to be created
    Allowed values: EPLS_k_ENABLE, EPLS_k_DISABLE*/
#define SPDO_cfg_CONNECTION_VALID_BIT_FIELD  EPLS_k_DISABLE
...
#define SPDO_cfg_MAX_TX_SPDO_MAPP_ENTRIES  2
...
#define SPDO_cfg_MAX_NO_RX_SPDO  4

/*  Maximum number of the Rx SPDOs of a SDG instance.
    Allowed values: 0 (for IO's)*/
#define SPDO_cfg_MAX_NO_RX_SPDO_SDG  2
...
/*  Maximum number of the Rx SPDO mapping entries
    Allowed values:
     ...
     if SPDO_cfg_MAX_NO_RX_SPDO == 0 then EPLS_k_NOT_APPLICABLE */
#define SPDO_cfg_MAX_RX_SPDO_MAPP_ENTRIES  1
