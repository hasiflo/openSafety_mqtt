 ...
 * \addtogroup Demo
 * \{
 * \defgroup UDP_SCM UDP based SCM
 * Implementation for a SCM using an UDP based SHNF
 * \{
 * \defgroup SAPL_UDP_SCM UDP Demo Safety Application
 * Implementation of the basic safety application for the UDP demo
 *
 * \defgroup SHNF_UDP_SCM UDP Demo Safety Hardware Communication Layer
 * Implementation of the HAL between the openSAFETY framework and the UDP network
 *
 * \defgroup Config_UDP_SCM UDP Demo Safety Configuration Manager
...
#define k_UDP_NETWORK_ALLOW_LOOPBACK 1
...
/** SAPL_k_SN2_SADR:
    Source address of the SN2 without SCM functionality
*/
#define SAPL_k_SN3_SADR            0x03U

#define SAPL_k_SN3_UDID     {BUR_MAC_VENDOR_ID,0x00U,0x00U,SAPL_k_SN3_SADR}
