/*
 * \file UDP_SCM\SAPL\SAPLsodCfgSpdo.h
 *
 * *****************************************************************************
...
*/
#define SAPL_k_SCM_SN1_ADD_SADR_1  4U

/** SAPL_k_SN_SANDARD_ADD_SADR_1:
    This symbol represents the first additional SADR of the SN standard.
*/
#define SAPL_k_SN2_ADD_SADR_1     5U
/** SAPL_k_SN_SANDARD_ADD_SADR_1:
    This symbol represents the first additional SADR of the SN standard.
*/
#define SAPL_k_SN3_ADD_SADR_1     6U
...
static UINT16  w_0_def_1400_01 SAFE_INIT_SEKTOR = SAPL_k_SN3_SADR;\
...
static UINT16  w_0_def_1400_07 SAFE_INIT_SEKTOR = 5000U;\
...
static UINT16  w_0_def_1400_09 SAFE_INIT_SEKTOR = 5000U;\
...
static UINT16  w_0_def_1401_01 SAFE_INIT_SEKTOR = SAPL_k_SPDO_DEACTIVATED;\
...
static UINT16  w_0_def_1401_07 SAFE_INIT_SEKTOR = 5000U;\
...
static UINT16  w_0_def_1401_09 SAFE_INIT_SEKTOR = 5000U;\
...
static UINT32 adw_0_def_1800_01[SAPL_k_NO_RX_SPDO_MAPP_ENTRIES] SAFE_INIT_SEKTOR = {0x60000208UL};\
/* 2 RX SPDO */\
...
static UINT32 adw_0_def_1801_01[SAPL_k_NO_RX_SPDO_MAPP_ENTRIES] SAFE_INIT_SEKTOR = {0x60000208UL}
...
static UINT16 w_0_def_1C00_01 SAFE_INIT_SEKTOR = SAPL_k_SCM_SN1_ADD_SADR_1;\
static UINT16 w_0_act_1C00_02 SAFE_NO_INIT_SEKTOR; /* Refresh prescale */\
static UINT16 w_0_def_1C00_02 SAFE_INIT_SEKTOR = 5000U; /*original 1000*/\
...
static UINT16 w_0_def_1C01_02 SAFE_INIT_SEKTOR = 5000U;/*original 1000 */\
...
static UINT32 adw_0_def_C000_01[SAPL_k_NO_TX_SPDO_MAPP_ENTRIES] SAFE_INIT_SEKTOR = {0x60000108UL};\
/* 2 TX SPDO */\
static UINT8    b_0_act_C001_00 SAFE_NO_INIT_SEKTOR; /* Number of Tx SPDO mapping entries */\
static UINT8    b_0_def_C001_00 SAFE_INIT_SEKTOR = SAPL_k_SPDO_DEACTIVATED;/*original SAPL_k_SPDO_DEACTIVATED */ \
static UINT32 adw_0_act_C001_01[SAPL_k_NO_TX_SPDO_MAPP_ENTRIES] SAFE_NO_INIT_SEKTOR; /* Tx SPDO mapping entries */\
static UINT32 adw_0_def_C001_01[SAPL_k_NO_TX_SPDO_MAPP_ENTRIES] SAFE_INIT_SEKTOR = {0x60000108UL}
